...
<br/><br/>
As an instructor, I would like to reduce confusion among students so that I may focus more on the lesson plan rather than reminding students where assignments are located and when they are due. The calendar feature for students to view their schedules and upcoming assignments is meant to keep students organized without having to navigate to different platforms. An all in one system — Swyng — having a calendar on the student’s landing page to show assignment dates, class meeting times, class locations, etc, should keep students from having to ask their instructors for information and reduce confusion. Some of the design choices include having the calendar visible on the student’s landing page so that it may be easily accessed at all times. When clicked, it navigates to a separate calendar page, with a large calendar taking up most of the screen, and a list of the student’s classes, approaching due dates, and grades button on the right. Having navigation buttons present makes it easier for students to navigate to classes from within the calendar page rather than going back to the main page and then selecting a class. Also, having color coded blocks in the calendar may help students distinguish the event types: lecture, due date, personal activities, etc.
...
<br/><br/>
The first additional feature we added to the grade calculator is a “calculate” button which autofills the calculator and calculates the averages for each category as well as the total average for the course. We added this feature in order to add an option for users who wanted a quick “summary-stats” of their standing in the course. The idea is minimal work, and users should be able to quickly view averages with little effort. The autofill feature enables this and minimizes the work for the user who does not have to manually calculate numbers. In addition to this, we added a banner which displays the course of which the grades are for to minimize confusion and increase overall organization. The final feature we kept was the ability for a user to customize their grade averages and add in theoretical values to see how their grade would change. This feature holds true to the original design of the grade calculator, which allows users to see potential grade changes which may occur in the future.
<iframe width="560" height="315" src="https://www.youtube.com/embed/uktY4olm3R4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<br/><br/>
As an instructor, I would like the ability to create quizzes and tests to my liking without having to deal with confusing interfaces and requirements. Instructors are used to using products like web assign, topcoat, and piazza. Swyng allows them to continue using these products with seamless linking features to bring the assignment into the system. When creating an assignment, instructors may choose from preexisting assignments developed in the aforementioned platforms. After linking, instructors select a due date and submit the assignment. While submitting, they may also notify the class that an assignment has been created/altered with a custom message. After creating an assignment, instructors may go back and edit the assignment. This simple interface makes it so that instructors don’t need to learn a new platform, they can simply use the ones they already know and link it with the click of a button.
<iframe width="560" height="315" src="https://www.youtube.com/embed/j2g7DcSQq4Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
